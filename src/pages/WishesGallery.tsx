  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-8">
        ...
        >
          <div
            className="bg-white/95 backdrop-blur-md rounded-[3rem] p-12 shadow-2xl text-center"
          ...
          >
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{ color: config.colors.textPrimary }}>
            ...
            <Link to="/">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-2xl font-bold text-white text-lg shadow-xl"
